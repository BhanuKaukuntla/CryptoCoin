      ...
      <div className="sidebar">
            <ul>
                ...
                <Link to="/cryptocurrencies">
                  <SidebarOption active Icon={AiFillMoneyCollect} text="Currencies" />
                </Link>
                </li>
                <li className="btn">
                <Link to="/exchanges">
                  <SidebarOption active Icon={BsBarChartFill} text="Exchanges" />
                </Link>
                </li>
                <li className="btn">
                <Link to="/news">
                  <SidebarOption active Icon={ImNewspaper} text="News" />
                </Link>
                </li>
            </ul>
        </div>
