...
import { FundOutlined, MenuOutlined } from '@ant-design/icons';
import { FaHome, GiCrownCoin, ImNewspaper, AiFillMoneyCollect } from 'react-icons/all';
    ...
    <div className="nav-container">
      ...
      <div className="sidebar">
            <ul>
                ...
                <li className="icons">
                <Link to="/exchanges">
                    <AiFillMoneyCollect className="icons" /> Exchangees
                </Link>
                </li>
                <li className="icons">
                <Link to="/news">
